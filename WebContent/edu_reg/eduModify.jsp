	...
	<form name= "eduModifyForm" method="post" action = "eduModify.do" enctype="multipart/form-data" onsubmit="return inputCheck()">
		...
		<c:forEach items = "${edu_detail }" var = "item2">
			...
			<tr>
				...
				<td><input type="number" name="input_time" onkeyPress="InputOnlyNumber(this);" value="${item2.input_time }">&nbsp;소요시간은 시 단위로 입력이 가능합니다</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><textarea class="form-control" rows="4" name="budget" maxlength="1000"
					style="width: 700px; height: 500px;">${item.budget }</textarea>
			...
			<tr>
				...
				<td><textarea class="form-control" rows="4" name="note" maxlength="1000"
					style="width: 700px; height: 500px;">${item.note }</textarea>
					<span style="float: right;"> 
			...
			<tr>
				...
				<td><input type="number" name="applicants_limit" value="${item.applicants_limit }"/>명</td>
			</tr>
			<tr>
		...
		<br/>	
		<div class="eduReqBtn">
			<input type="submit" value="수정하기" class="w3-button w3-white w3-border"/>
		</div>
		<br/>
		<br/>
