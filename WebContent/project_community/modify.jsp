...
<body>
	...
	<form name=insertForm class="form-horizontal" method="post"
		...
		<span
			style="font-family: 'Jeju Gothic', serif; font-size: 20px; color: black;">${result.title}
		</span><br> <br>
		<br>
		<span
			style="font-family: 'Jeju Gothic', serif; font-size: 20px; color: black;">게시글</span><br>
		<textarea class="form-control" rows="10" name="text"
			style="width: 700px; height: 800px;"></textarea>

		<br> <span>첨부파일</span> <a
			href="ProjectFileDownload.do?project_no=${result.project_no}">${result.file_ori_name}</a>

		<div class="form-group">
			<br>
			<span
				style="font-family: 'Jeju Gothic', serif; font-size: 10; color: black;">파일수정
				: </span> <input type="file" name="upfile" size="20"
		...
		<br> <br>
		<button style="font-family: 'Jeju Gothic', serif;" type="submit">작성
			완료</button>
	</form>
